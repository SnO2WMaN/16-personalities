...
> = ({ className, char, chars }) => {
	return (
		...
		>
			<div className="w-[64px] h-[64px] text-2xl font-bold font-mono select-none flex justify-center items-center">
				{chars[0]}
			</div>
			<div className="w-[64px] h-[64px] text-2xl font-bold font-mono select-none flex justify-center items-center">
				{chars[1]}
...
export function Slot({
	...
	return (
		<div className={clsx(className)}>
			<div className={clsx("relative w-[256px] h-[192px] overflow-hidden")}>
				<div
					className={clsx(
						"flex absolute top-0",
						css`
				...
				{personality && (
					<p className="text-lg text-slate-900">
						...
						<a
							...
							className="text-blue-500 underline"
						>
							<span>{personality}</span>（<span>{job[personality]}</span>
							）型
						</a>
						の人間です
					</p>
